...
class RecraftBackgroundTest extends TestCase
{
    ...
    public function testInvalidResponse( array $response ) : void
    {
        ...
        $provider->background( Image::fromUrl( 'https://example.com/image.png' ), 'Forest' );
    }
    ...
    public static function invalidArguments() : array
    {
        ...
        return [
            ['background', [$image, 'Forest', ['mask' => 'bad']]],
        ];
    }
