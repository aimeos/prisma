...
class RecraftInpaintTest extends TestCase
{
    ...
    public function testInvalidResponse( array $response ) : void
    {
        ...
        $provider->inpaint( Image::fromUrl( 'https://example.com/image.png' ), Image::fromUrl( 'https://example.com/mask.png' ), 'Glasses' );
    }
