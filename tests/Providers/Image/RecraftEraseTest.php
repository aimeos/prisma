...
class RecraftEraseTest extends TestCase
{
    ...
    public function testInvalidResponse( array $response ) : void
    {
        ...
        $provider->erase( Image::fromUrl( 'https://example.com/image.png' ), Image::fromUrl( 'https://example.com/mask.png' ) );
    }
